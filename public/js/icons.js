/**
 * Ambients - High-Performance Self-Contained SVG Icon Registry
 * 100% Zero external CDN dependency; renders instantly with crisp vector graphics
 */
...
export const SVG_ICONS = {
  ...
  'maximize-2': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="15 3 21 3 21 9"/><polyline points="9 21 3 21 3 15"/><line x1="21" x2="14" y1="3" y2="10"/><line x1="3" x2="10" y1="21" y2="14"/></svg>',
  ...
  'pause': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>',
  ...
  'link-2': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 17H7A5 5 0 0 1 7 7h2"/><path d="M15 7h2a5 5 0 1 1 0 10h-2"/><line x1="8" x2="16" y1="12" y2="12"/></svg>',
  ...
  'volume-2': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>',
  'volume-x': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><line x1="22" x2="16" y1="9" y2="15"/><line x1="16" x2="22" y1="9" y2="15"/></svg>',
  ...
  'timer': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="10" x2="14" y1="2" y2="2"/><line x1="12" x2="12" y1="14" y2="8"/><circle cx="12" cy="14" r="8"/></svg>',
  ...
  'arrow-right': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" x2="19" y1="12" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>',
  'help-circle': '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><line x1="12" x2="12.01" y1="17" y2="17"/></svg>',
...
export function renderIcons(root = document) {
  const elements = root.querySelectorAll('i[data-lucide], [data-lucide]');
  elements.forEach(el => {
    const iconName = el.getAttribute('data-lucide');
    if (!iconName) return;

    const svgString = SVG_ICONS[iconName] || SVG_ICONS['sparkles'];
    if (svgString) {
      const temp = document.createElement('div');
      temp.innerHTML = svgString.trim();
      const svg = temp.firstElementChild;
      
      // Preserve any custom classes on the original element
      if (el.className) {
        svg.setAttribute('class', (svg.getAttribute('class') || '') + ' ' + el.className);
      }
      
      // Inherit width/height classes if present (e.g. w-4 h-4)
      if (el.classList.contains('w-3')) { svg.setAttribute('width', '12'); svg.setAttribute('height', '12'); }
      else if (el.classList.contains('w-3.5')) { svg.setAttribute('width', '14'); svg.setAttribute('height', '14'); }
      else if (el.classList.contains('w-4')) { svg.setAttribute('width', '16'); svg.setAttribute('height', '16'); }
      else if (el.classList.contains('w-5')) { svg.setAttribute('width', '20'); svg.setAttribute('height', '20'); }
      else if (el.classList.contains('w-8') || el.classList.contains('w-12')) { svg.setAttribute('width', '36'); svg.setAttribute('height', '36'); }
